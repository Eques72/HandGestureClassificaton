...
parentDirectory = cn.os.path.abspath(cn.os.path.join(cn.os.getcwd(), cn.os.pardir))
...
def main():
    ...
    cn.SaveModel(
        model, 
        cn.os.path.join(parentDirectory, "HandGestureClassificaton\\DATA\\TrainedModels"), 
...
datasetDirPath = cn.os.path.join(parentDirectory, "HandGestureClassificaton\\DATA\\cropped")
#Train pipeline
